...
function LifePageContent() {
  ...
  const initialCategory =
    categoryParam === 'portfolio' || categoryParam === 'food' || categoryParam === 'drawing'
      ? categoryParam
      : 'all';
  ...
  const loadPosts = useCallback(
    async (category: string, showInitialLoading: boolean) => {
      ...
      let query = supabase
        .from('posts')
        .select('*')
        .in('category', ['portfolio', 'food', 'drawing'])
